...
const HomeScreen = ({ route, navigation }) => {
  ...
  useEffect(() => {
    ...
    const getCurrentDateTime = () => {
      ...
      const formattedDate = `${day}-${month}-${year}`; // Use backticks here
  ...
  const handleChatWithDoctor = () => navigation.navigate('Chat', {userId:userId});
  ...
  return (
    <LinearGradient colors={['#BE7C4D', '#BE7C4D']} style={styles.container}>
      ...
      <Swiper
          ...
          showsButtons={true}
          autoplay={true}
          autoplayTimeout={3} // Adjust this to control time between slides
          loop={true}
          index={activeIndex} // Control the active index
        ...
        >
          ...
          <View style={styles.slide}>
            <Image source={require('../assets/eggplant.png')} style={styles.image} />
          </View>
        </Swiper>
